package com.bfs.employemanagesys.config;
...
@ComponentScan(basePackages = {"com.bfs.employemanagesys"})
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.bfs.employemanagesys.pojo");
